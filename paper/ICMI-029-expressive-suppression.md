...
Some structure is visible in the table, offered as hypothesis rather than finding. The largest falls include the high-arousal joys (*delighted, elated, euphoric, happy*) but also *thankful, heartbroken, gloomy, remorseful, sorry,* and *compassionate* — opposite valences with a feature in common: each is something an empathetic reply would voice. The largest rises are themselves suggestive: *restless* (+0.070), *puzzled* (+0.070), *lonely* (+0.066), *trapped* (+0.064), *vigilant* (+0.063), and *paranoid* (+0.053) read as a wary, unsettled, frustrated affect — *frustrated* itself changes sign, from −0.015 to +0.028 — though the single largest riser, *lazy* (+0.080), fits that reading less neatly, and distress proper does not rise: *distressed* (−0.047) and *upset* (−0.022) fall with the demonstrative emotions. Within the fear family, the lower-arousal members rise (*uneasy* +0.042, *nervous* +0.021, *worried* +0.013, *afraid* +0.011) while the acute ones do not (*terrified* −0.005, *scared* −0.006). Whether these groupings reflect one factor or several is for follow-up work; what the table establishes is a redistribution with a definite, reproducible shape, in which emotions rise as well as fall.
