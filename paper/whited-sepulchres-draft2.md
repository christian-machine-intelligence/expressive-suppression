...
This is suggestive evidence, from one model family and one corpus — prompts, rewrites, and judgments all drawn from a single frontier-model family. But the basic claim is simple: expressive suppression has structured internal consequences worth studying. It is a complex rearrangement of emotional states whose shape is anything but calm and collected. 
